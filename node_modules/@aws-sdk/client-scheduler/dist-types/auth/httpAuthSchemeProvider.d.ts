 ...
 * @internal
 */
export interface SchedulerHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<SchedulerClientResolvedConfig, HandlerExecutionContext, SchedulerHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultSchedulerHttpAuthSchemeParametersProvider: (config: SchedulerClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<SchedulerHttpAuthSchemeParameters>;
/**
 * @internal
 */
