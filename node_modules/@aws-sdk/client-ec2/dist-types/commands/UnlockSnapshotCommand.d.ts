...
declare const UnlockSnapshotCommand_base: {
    new (input: UnlockSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<UnlockSnapshotCommandInput, UnlockSnapshotCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UnlockSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<UnlockSnapshotCommandInput, UnlockSnapshotCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
