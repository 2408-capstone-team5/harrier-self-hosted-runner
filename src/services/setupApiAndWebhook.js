...
var create_workflow_lambdaRoleWithPolicies_1 = require("../utils/aws/iam/create_workflow_lambdaRoleWithPolicies");
...
function setupApiAndWebhook() {
    return __awaiter(this, void 0, void 0, function () {
        var wait, roleName, serviceRoleArn, _a, restApiId, resourceId, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    wait = function (ms) {
                        console.log("waiting ".concat(ms / 1000, " seconds..."));
                        var start = Date.now();
                        var now = start;
                        while (now - start < ms) {
                            now = Date.now();
                ...
                case 1:
                    _b.trys.push([1, 8, , 9]);
                    roleName = "roleName";
                    return [4 /*yield*/, (0, create_workflow_lambdaRoleWithPolicies_1["default"])(roleName)];
                case 2:
                ...
                case 3:
                    _b.sent();
                    wait(5000);
                    return [4 /*yield*/, (0, setupRestApi_1["default"])()];
                case 4:
